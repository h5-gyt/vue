<template>
	<div class="detail">
		<UcNav/>
		<div class="content">
			<div class="header clear"><h2><img src="/img/head.png" alt=""/></h2><p>作者名字</p></div>
				<div class="cont">
...
<script>
	...
	import ToolBar from '../components/uc-toolbar.vue'
	...
	export default {
	  ...
	  mounted() {
		  axios({
			  ...
			  headers:{
			  	token:'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Imd5dCIsIl9pZCI6IjVlNzRiZjAzOTYxY2Q1NTVjY2U1MzUyMiIsImlhdCI6MTU4NDc1NDg3OSwiZXhwIjoxNTg0ODQxMjc5fQ.3-tPEK-UXpft7TTBUViUyrG9SDtbZGdTXYwsjMpUNQA'
			  }
		  }).then(
...
<style scoped>
	...
	.cont h3{ font-size:0.4rem; line-height:0.6rem; padding-bottom:0.25rem; border-bottom:1px solid #494d4d; text-align: left;}
	...
	.cont .text-box{ font-size:0.25rem;text-align: left;}
